...
export const mapPaymentCategoriesToUI = (
  response: PaymentCategoriesAPI,
): PaymentCategoriesUI => {
  return {
...
export const mapPaymentCategoryToUI = (
  response: PaymentCategoryAPI,
): PaymentCategoryUI => {
  return {
...
export const mapPaymentServiceToUI = (
  response: PaymentServiceAPI,
): PaymentServiceUI => {
  return {
